...
if(isset($_GET['id']) && $_GET['id'] > 0){
    ...
    if($booking_qry->num_rows > 0){
        ...
        $date_created = $booking_data['date_created'];
...
<body>
    ...
    <div class="receipt-container">
        ...
        <div class="receipt-footer">
            <div class="footer-info">
                ...
                <span class="footer-value"><?= date("F d, Y", strtotime($date_created)) ?></span>
            </div>
            <div class="footer-info">
            ...
            <div class="footer-info">
                <span class="footer-label">Catalunan Grande Sports Complex</span>
                <span class="footer-label">All Rights Reserved</span>
            </div>
    ...
    <script>
        ...
        function goBack() {
            window.location.href = 'http://localhost/capstoneProj/?p=booking_list';
        }
    </script>
