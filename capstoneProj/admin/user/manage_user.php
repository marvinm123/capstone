...
<!-- Move these styles outside the conditional statement -->
...
<div class="card card-outline">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($_GET['id']) ? 'Update User' : 'Create New User' ?></h3>
	</div>
	<div class="card-body">
		...
		$.ajax({
			...
			success:function(resp){
				if(resp ==1){
					...
					$('#msg').html('<div class="alert alert-success">User successfully ' + (<?php echo isset($_GET['id']) ? 'true' : 'false' ?> ? 'updated' : 'created') + '! Redirecting to user list...</div>');
